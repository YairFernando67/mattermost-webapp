...
function TrialBenefitsModal(props: Props): JSX.Element | null {
    ...
    const ldapSlide = (
        <div className="slide-container">
            ...
            <a className="learnMoreButton" onClick={() => redirectToConsolePage(ConsolePages.LDAP)}>Learn More</a>
            <LdapSvg width={300} height={300}/>
        </div>
    );
    ...
    const dataRetentionSlide = (
        <div className="slide-container">
            ...
            <a className="learnMoreButton" onClick={() => redirectToConsolePage(ConsolePages.DATA_RETENTION)}>Learn More</a>
            <PersonWithBoxSvg width={300} height={300}/>
        </div>
    );
    ...
    const complianceExportSlide = (
        <div className="slide-container">
            ...
            <a className="learnMoreButton" onClick={() => redirectToConsolePage(ConsolePages.COMPLIANCE_EXPORT)}>Learn More</a>
            <PersonMacSvg width={300} height={300}/>
        </div>
    );
    ...
    const controlledAccessSlide = (
        <div className="slide-container">
            ...
            <a className="learnMoreButton" onClick={() => redirectToConsolePage(ConsolePages.SYSTEM_ROLES)}>Learn More</a>
            <PersonWithServersSvg width={300} height={300}/>
        </div>
    );
    ...
    const customTermsSlide = (
        <div className="slide-container">
            ...
            <a className="learnMoreButton" onClick={() => redirectToConsolePage(ConsolePages.CUSTOM_TERMS)}>Learn More</a>
            <PersonWithSheetSvg width={300} height={300}/>
        </div>
    );
